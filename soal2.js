...
const dataSample = `03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
fs.appendFile(fileName, dataSample, (err) => {
    if (err) {
        console.error('Terjadi kesalahan:', err);
    } else {
        console.log(`Data berhasil ditulis ke dalam ${fileName}`);
    }
});
